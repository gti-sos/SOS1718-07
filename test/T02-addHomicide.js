...
describe('Add homicide', function(){  //compruebo que los datos se cargan
            ...
            .then(function(){
                element
                    ...
                    .then(function(homicides){ //carga todos los homicidios
                        ...
                        element(by.model('newHomicide.year')).sendKeys(2342);
                        element(by.model('newHomicide.month')).sendKeys('July');
                        element(by.model('newHomicide.state')).sendKeys('Alabama');
                        ...
                        element(by.model('newHomicide.victim_count')).sendKeys('100');
                        
                        element(by.buttonText('Add')).click().then(function(){
                            
                            element.all(by.repeater('homicide in homicides').then(function(homicides){ 
                                expect(homicides.length).toEqual(homicides.length+1);
